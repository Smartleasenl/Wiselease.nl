...
export function WhyWiselease() {
  ...
  return (
    <section ref={sectionRef} className="relative py-20 md:py-28 overflow-hidden bg-[#0f1e3d]">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 -left-32 w-96 h-96 bg-yellow-500/10 rounded-full blur-[120px] animate-pulse" style={{ animationDuration: '8s' }} />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-yellow-500/5 rounded-full blur-[150px] animate-pulse" style={{ animationDuration: '12s', animationDelay: '4s' }} />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-16 transition-all duration-1000 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm border border-white/10 text-yellow-400 px-4 py-2 rounded-full mb-6">
        ...
        <div className={`transition-all duration-1000 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '800ms' }}>
          <div className="relative bg-gradient-to-r from-white/[0.06] to-white/[0.03] backdrop-blur-md border border-white/[0.1] rounded-2xl p-8 md:p-10">
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-yellow-500/5 via-transparent to-blue-500/5 pointer-events-none" />
            <div className="relative grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
              <div ref={c1.ref} className="text-center">
                <div className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-1 tracking-tight">
                  {c1.count.toLocaleString('nl-NL')}<span className="text-yellow-400">+</span>
                </div>
              ...
              <div ref={c2.ref} className="text-center">
                <div className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-1 tracking-tight">
                  {c2.count}<span className="text-yellow-400">+</span>
                </div>
              ...
              <div ref={c3.ref} className="text-center">
                <div className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-1 tracking-tight">
                  <span className="text-yellow-400">4</span>,{c3.count - 40}<span className="text-white/60">/5</span>
                </div>
              ...
              <div ref={c4.ref} className="text-center">
                <div className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-1 tracking-tight">
                  <span className="text-yellow-400">24</span>/7
                </div>
        ...
        <div className={`text-center mt-12 transition-all duration-1000 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '1000ms' }}>
          <button
            ...
            className="group inline-flex items-center gap-2.5 bg-gradient-to-r from-yellow-400 to-amber-500 hover:from-yellow-300 hover:to-amber-400 text-gray-900 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 shadow-xl shadow-yellow-500/25 hover:shadow-yellow-500/40 hover:-translate-y-0.5"
          >
            Bekijk ons aanbod
