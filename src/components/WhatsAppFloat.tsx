...
export function WhatsAppFloat() {
  ...
  const hidden = ['/admin'].some(p => location.pathname.startsWith(p));
  ...
  return (
    <a
      ...
      className="hidden lg:flex fixed bottom-6 right-6 z-50 items-center gap-3 bg-[#25D366] hover:bg-[#20c05c] text-white font-semibold px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all"
