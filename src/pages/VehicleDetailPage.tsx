...
const handleWhatsApp = () => {
  ...
  const maandbedrag = vehicle.maandprijs ?? calculatorState?.maandbedrag ?? 0;
                    ...
                    <>
                      <div className="flex items-baseline gap-2">
                        <span className="text-3xl md:text-4xl font-bold text-smartlease-yellow">
                          € {(vehicle.maandprijs ?? calculatorState?.maandbedrag ?? 0).toLocaleString('nl-NL')},-
                        </span>
            ...
            {vehicle.verkoopprijs > 0 ? (
              <>
                ...
                <p className="text-xl font-bold text-smartlease-yellow">
                  € {(vehicle.maandprijs ?? calculatorState?.maandbedrag ?? 0).toLocaleString('nl-NL')} p/m
                </p>
              </>
            ) : (
              <>
